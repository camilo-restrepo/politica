...
public class StopwordsSpanish {
	...
	public StopwordsSpanish() {
		String[] words = { "él", "ésta", "éstas", "éste", "éstos", "última", "últimas", "último", "últimos", "a",
				...
				"pacho", "francisco", "-" , "http", "rt", "daniel", "raisbeck", "am", "pm", "debate", "hollman", "propuesta",
				"propuestas", "encuesta", "encuestas", "sabe", "gracias", "candidata", "foro", "tema", "expresado", "localidad",
				"seguimos", "señor", "retiran", "vernot"};
